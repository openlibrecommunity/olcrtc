...
func parseFlags() config {
	...
	flag.IntVarP(&cfg.socksPort, "port", "P", 1080, "SOCKS5 port: upstream proxy for server / connection port for client")
	flag.StringVarP(&cfg.socksHost, "host", "H", "127.0.0.1", "SOCKS5 host: upstream proxy for server / connection address for client")
